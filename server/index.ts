...
(async () => {
  ...
  // Unmatched /api/* paths return JSON 404 instead of falling through to the
  // SPA catch-all (which would serve index.html with a 200). Registered after
  // every real API route but before the Vite/static SPA handlers.
